  ...
  try {
    ...
    try {
      ...
      const sock = makeWASocket({
        ...
        keepAliveIntervalMs: 30000, // Keep-alive every 30 seconds to maintain connection


        connectTimeoutMs: 120000, // 120 seconds for connection timeout
        ...
        try {
          ...
          if (qr) {
            ...
            setTimeout(() => {
              ...
              }, 5000); // Changed from 10000 to 5000 for more frequent updates
          ...
          if (connection === 'close') {
            ...
            const isQRTimeout = statusCode === 408 && errorMessage.includes('QR refs attempts ended');
...
async function handleIncomingMessage(
  ...
  try {
    ...
    if (!isGroupChat && isWhatsAppGroupChatId(phoneNumber)) {
